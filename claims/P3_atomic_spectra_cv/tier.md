...
**Justification:** Reproduction script at consistency/nist_spectra.py [REVIEWER-RUN]; T2 deferred pending precise prediction-metric specification and NIST data fetch.
