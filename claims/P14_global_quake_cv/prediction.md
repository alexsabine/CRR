# P14 — Pre-registered prediction (Session 7)
...
1. Source: USGS ANSS global catalogue.
2. Inclusion: M ≥ 6.0 mainshocks 2000-present, declustered.
3. Statistic: CV = SD(inter-arrival)/mean.
...
CV outside [0.08, 0.40] ⇒ Z₂ fails for global quake catalogue.
...
Global quake inter-arrival CV is known to be near 1 (Poissonian) for declustered catalogues — ~0.16 would be non-trivial.
