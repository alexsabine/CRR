...
**Justification:** T1. Derivation is one substitution. Caveat: the 'limit' is a formal specialisation, not a topological limit (Ω is taken complex). Verified via test_fourier_limit_kernel_*.
