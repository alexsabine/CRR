# P11 — Pre-registered prediction (Session 7)
...
1. Source: McQuillan et al. 2014 catalogue.
2. Inclusion: solar-type subset (Teff 5500–6000 K).
3. Statistic: CV = SD(rotation period) / mean(rotation period) across the cohort.
...
median(CV) > 0.30 ⇒ SO(2) fails for stellar rotation.
...
Stellar rotation period spread in McQuillan cohort is dominated by age/spin-down; CV across uniform spectral type may not match SO(2) cleanly. Honest exposure: this could fail.
