...
**Justification:** T1 with caveat. Derivation rests on Moser's twist-map theorem; minimum-depth claim holds under implicit 1-D state-variable assumption. Verified qualitatively via test_M8_depth_two_torus_dim.
